    ...
    <div className="aboutMeContentTechContainer">
      <section className="aboutMeContent">
        <div className="aboutMeText">
          <p>Fullstack Javascript Web Developer here, eager for opportunities to work in the <a href="http://mern.io/" target="_blank" title="MERN stack"><strong>MERN</strong></a> stack or to grow into other stacks. You can find several examples of my work under Apps.</p>
          <p>I love coding. I love the creativity it enables, and the satisfaction of solving problems through it. It's amazing how we can shape our world, representing and molding it with the electrons in our machines.</p>
