      ...
      <div className="aboutMeContentTechContainer">
        <section className="aboutMeContent">
          <div className="aboutMeText">
            ...
            <p>I love coding. I love the creativity it enables and the satisfaction when writing features into existence. I'm amazed at how we can shape our world through representing and molding it with the electrons in our machines.</p>
